...
// Open EOS Camera's own class ID, distinct from the Microsoft sample.
DEFINE_GUID(CLSID_VirtualCameraMediaSource ,
    0xead49f23, 0x8f8c, 0x47e7, 0xa7, 0x8c, 0xf7, 0x74, 0x4a, 0x6d, 0x54, 0xc9);

static LPCWSTR VIRTUALCAMERAMEDIASOURCE_CLSID = L"{EAD49F23-8F8C-47E7-A78C-F7744A6D54C9}";
static LPCWSTR VIRTUALCAMERAMEDIASOURCE_FRIENDLYNAME = L"Open EOS Camera (test pattern)";
